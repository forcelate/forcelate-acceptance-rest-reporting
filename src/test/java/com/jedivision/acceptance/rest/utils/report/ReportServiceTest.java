...
import static com.jedivision.acceptance.rest.utils.test.JediRandomUtils.*;
...
public class ReportServiceTest {
    ...
    public void formatReport() throws AcceptanceException {
        ...
        ExecutionsHolder.addExecution(description(endpoint1, httpType1), SUCCESS, randomString());
        ExecutionsHolder.addExecution(description(endpoint2, httpType2), FAILURE, randomString());
